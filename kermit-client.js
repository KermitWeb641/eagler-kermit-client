(function () {
	...
	function createUI() {
		...
		root.innerHTML = '<style>' +
			'.impact-client-root{position:fixed;inset:0;z-index:2147483000;pointer-events:none;font-family:Arial,Helvetica,sans-serif;color:#fff;text-shadow:1px 1px 2px #000;}' +
	...
	setInterval(autoAttackPulse, 1000 / 30);
	setInterval(importNextBundledTexturePack, 250);
